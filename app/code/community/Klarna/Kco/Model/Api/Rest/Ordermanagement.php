 ...
 */
class Klarna_Kco_Model_Api_Rest_Ordermanagement extends Klarna_Kco_Model_Api_Rest_Client_Abstract
{
    /**
    ...
    public function updateOrderItems($id, $data)
    {
        ...
        $request = $this->getNewRequestObject()
            ->setUrl($url)
            ->setMethod(Klarna_Kco_Model_Api_Rest_Client_Request::REQUEST_METHOD_PATCH)
            ->setParams($data)
            ->setDefaultErrorMessage('Error: Unable to acknowledge order.');
    ...
    public function updateMerchantReferences($id, $merchantReference1, $merchantReference2 = null)
    {
        ...
        Mage::dispatchEvent(
            'kco_rest_merchant_reference_update', array(
            'order_id' => $id,
            'data'     => $data
            )
        );
    ...
    public function addShippingDetailsToCapture($id, $captureId, $data)
    {
        ...
        $request = $this->getNewRequestObject()
            ...
            ->setMethod(Klarna_Kco_Model_Api_Rest_Client_Request::REQUEST_METHOD_POST)
            ->setParams($data)
            ->setDefaultErrorMessage('Error: Unable to add shipping info to capture.');
